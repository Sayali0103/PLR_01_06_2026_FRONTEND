...
export default function BookDemo() {
  return <InquiryFormPage eyebrow="Book a Demo" title="See P. L. Robotics" accentTitle="In Action." headingSize="clamp(34px, 4.2vw, 56px)" description="Share your requirements and our team will get in touch to understand your application and arrange the right demonstration." endpoint="/demo-requests" fields={fields} successMessage="Your demo request has been received. The P. L. Robotics team will contact you to discuss the next steps." helperLink={{ to: '/faq', label: 'Check common questions first' }} />
}
